...
namespace Haley.Rest
{
    public static class ClientStore
    {
        ...
        public static IClient AddClient(Enum @enum, string base_uri, string friendly_name,Func<HttpRequestMessage,Task<bool>> requestvalidation = null,ILogger logger = null)
        { return AddClient(@enum.GetKey(), base_uri,friendly_name,requestvalidation, logger); }

        public static IClient AddClient(string key, string base_uri, string friendly_name, Func<HttpRequestMessage, Task<bool>> requestvalidation = null, ILogger logger = null)
