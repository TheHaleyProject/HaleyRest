    ...
    internal class Program
    {
        ...
        static async Task<bool> CallMethod() {
            try {
                ...
                var authheader = ApiAdapters.OAuth1.GetAuthorizationHeader(new OAuthToken("4579bfc5-0671-4087-bed3-00a41b5cff8c", "f292-3177-e0b1-22ae-e253-5bfd-dbec-84d5"), OAuthRequestType.RequestToken,new OAuthRequest() { Method = Haley.Enums.Method.POST,RequestURL = $@"https://daep.withbc.com/oauth/request_token" });
        ...
        static async Task<bool> RestSharpCall() {
            ...
            var request = new RestRequest("oauth/request_token", RestSharp.Method.Post);
